...
import requests
import time
import typing #typing is an more advance library for casting
import collections
...
class BinanceClient:
    ...
    # public_key: str, specifies the input public_key is a string
    ...
    # typing.Dict doesn't not speficy the type of the keys and values of the dictionary because
    #   the values can be of multiple types (int, float, str...)
    ...
    def get_historical_candles(self, contract: Contract, interval: str) -> typing.List[Candle]:
        ...
        if raw_candles is not None:
            for c in raw_candles:
                ...
                # by calling the Candle class in models.py, it'll populate the caldes array
            ...
            for contract in contracts:
                if contract.symbol not in self.ws_subscriptions[channel] or reconnection:
                    ...
                    if contract.symbol not in self.ws_subscriptions[channel]:
                        self.ws_subscriptions[channel].append(contract.symbol) #prevent from subscribing same symbol twice
