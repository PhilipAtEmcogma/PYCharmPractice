...
class Root(tk.Tk):
    def __init__(self, binance: BinanceClient, bitmex: BitmexClient):
        ...
        # instantiate bitmex and binance
        ...
        # tearoff = False, means workspace_meni can't be detached from main menu
        ...
        # _ infront of the variable name, makes it a private variable
